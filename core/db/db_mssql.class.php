 ...
 * @version $Id:db_mssql.class.php 1.3 2011-11-13 20:35:00Z tommy $
 * @since 1.0
 */
...
class db_mssql extends Base {
    ...
    public function __construct($params = array()) {
        ...
        if (!$params['host'] || !$params['username'] || !$params['password'] || !$params['dbname']) {
            Controller::halt('Database Server HostName or UserName or Password or DatabaseName error in the config file!');
        }
        ...
        if (!$this->dbLink) {
            Controller::halt($params['driver'] . ' Server connect fail! <br/>Error Message:' . $this->error());
        }
